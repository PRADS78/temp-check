...
describe("Label and its variants' appearance", () => {
  ...
  beforeAll(async () => {
    ...
    const storyGroupButton = await page.waitForSelector(`#disprz-disprzlabel`);
  ...
  test("Standard", async () => {
    const explorerNodeId = "disprz-disprzlabel--standard";

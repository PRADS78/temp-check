...
describe("Tag and its variants' appearance", () => {
  ...
  beforeAll(async () => {
    ...
    const storyGroupButton = await page.waitForSelector(`#disprz-disprztag`);
  ...
  test("Standard", async () => {
    const explorerNodeId = "disprz-disprztag--standard";
    const fileName = "standard";
    await runScreenshotTest({ explorerNodeId, fileName });
  });

  test("Rating", async () => {
    const explorerNodeId = "disprz-disprztag--rating";
